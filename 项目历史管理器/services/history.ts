...
import { managerProjectName, managerProjectPath } from "../constants"
...
export function isSelfProject(project: ProjectHistory) {
  return (
    isSamePath(project.projectPath, managerProjectPath) ||
    Path.basename(project.projectPath) === managerProjectName ||
    project.name === managerProjectName
  )
}
